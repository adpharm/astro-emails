...
async function writeStaticFile(obj: any, outputFile: string) {
  const content = `// This file is generated automatically by tailwind-themes/scripts.ts
// Do not edit this file directly.
// To regenerate this file, run:
//   npm run script -- ./tailwind-themes/scripts.ts
// 
...
writeStaticFile(createBorderClasses(), "./tailwind-themes/borderClasses.ts");
